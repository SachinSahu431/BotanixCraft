...
export const NETWORK_NAME = 'SpiderChain Testnet';
export const RPC_URL = 'https://node.SpiderChainlabs.dev';
export const CHAIN_ID = 3636;
export const BLOCK_EXPLORER_URL = 'https://blockscout.SpiderChainlabs.dev/';
export const ICON = 'https://a-us.storyblok.com/f/1014909/512x512/026e26392f/dark_512-1.png';